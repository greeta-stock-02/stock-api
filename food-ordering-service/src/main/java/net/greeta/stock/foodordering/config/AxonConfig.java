package net.greeta.stock.foodordering.config;

import com.thoughtworks.xstream.XStream;
import net.greeta.stock.foodordering.interceptor.CommandLoggingDispatchInterceptor;
import net.greeta.stock.foodordering.interceptor.EventLoggingDispatchInterceptor;
