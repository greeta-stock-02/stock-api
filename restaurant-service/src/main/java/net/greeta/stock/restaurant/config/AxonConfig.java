package net.greeta.stock.restaurant.config;

import net.greeta.stock.restaurant.interceptor.CommandLoggingDispatchInterceptor;
import net.greeta.stock.restaurant.interceptor.EventLoggingDispatchInterceptor;
